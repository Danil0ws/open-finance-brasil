# Cenário 9: credit-portability_api_portability-payment_core_test-module_v1 - Crédito Pessoal sem Consignação
...
Rotina de tempo com a chamada de endpoint GET /portabilities/{portabilityId} por 10 minutos enquanto encontrar status igual a ACCEPTED\_SETTLEMENT\_COMPLETED

Status 200 - Validação de resposta e garantia que o status seja igual "PORTABILITY\_COMPLETED"
