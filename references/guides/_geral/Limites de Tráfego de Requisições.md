...
-   Número de chamadas - o número de chamadas de _endpoint_ iniciadas por uma duração especificada.
...
Requisições que ultrapassem os limites estabelecidos poderão ser rejeitadas utilizando o HTTP _status code_:`429 Too Many` `Requests`.
