# Orientações - [DC] Cartão de Crédito
...
### Recomendações do uso de _polling_
...
200 - Retorna o recurso com status TEMPORARY\_ UNAVAILABLE
...
-   Pagamentos efetuados a partir do momento que uma nova fatura é fechada e exposta, devem estar atrelados a essa fatura através da lista **/data/payments** do endopoint **GET /accounts/{creditCardAccountId}/bills**, até que haja um novo fechamento de fatura. Exceto para pagamentos de faturas realizados para liberação de limite ou pagamentos adiantados, estes devem ser reportados na próxima fatura subsequente quando for efetivamente fechada. Enquanto não ocorre o fechamento, ele deve ser reportado só nos **GET /accounts/{creditCardAccountId}/transactions e transactions-current**
    
-   Como exemplo de preenchimento da lista **/data/payments**, temos o cenário a seguir:
...
-   Os filtros **fromTransactionDate** e **toTransactionDate** devem levar em conta o campo **transactionDateTime** para realização da consulta nos _endpoints_ de _transactions_
