...
## 2 - Regras de negócios para _Transferências Inteligentes_
...
## 3 - Descrição da usabilidade para _Transferências Inteligentes_
...
![ConsentimentoSweeping\_v2-20241010-193208.png](images/ConsentimentoSweeping_v2-20241010-193208.png)
...
-   REVOGADO\_RECEBEDOR: Não se aplica ao produto Transferências inteligentes. Nesse produto, o recebedor e o pagador são de mesma titularidade, portanto, sempre que revogado, será revogado pelo usuário.
    
-   REVOGADO\_USUARIO: Indica que o usuário pagador, via ambiente do iniciador ou detentor, solicitou a revogação do consentimento de longa duração.
...
![LiquidacaoSweepingAccount\_v2-20241010-204631.png](images/LiquidacaoSweepingAccount_v2-20241010-204631.png)
