# Documentação Técnica - API Portabilidade de Crédito
...
Para o entendimento correto do produto você deve levar em consideração as informações presentes na página [\[PC\] API - Portabilidade de Crédito - CPC](https://openfinancebrasil.atlassian.net/wiki/pages/createpage.action?spaceKey=draftof&title=%5BPC%5D%20API%20-%20Cr%C3%A9dito%20Pessoal%20Clean%20-%20CPC&linkCreation=true&fromPageId=1320747009).
...
[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/creditPortabilityPostPortabilities_v1.0.0.csv)
...
[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/creditPortabilityGetPortabilitiesByPortabilityId_v1.0.0.csv)
...
[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/creditPortabilityPatchPortabilitiesPortabilityIdCancel_v1.0.0.csv)
...
[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/creditPortabilityGetCreditOperationsContratIdPortabilityEligibility_v1.0.0.csv)
...
[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/creditPortabilityGetAccountData_v1.0.0.csv)
...
[Fazer download do dicionário de dados](https://openbanking-brasil.github.io/draft-openapi/dictionary/creditPortabilityPostPortabilitiesPortabilityIdPayment_v1.0.0.csv)
