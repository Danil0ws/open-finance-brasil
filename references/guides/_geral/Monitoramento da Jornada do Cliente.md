...
Atualmente o **monitoramento das jornadas é executado em ciclos trimestrais**, sendo:
...
-   [IN 706](data/references/Instrução_Normativa_BCB_706.md) - Divulga a versão 3.0 do Manual de Monitoramento do Open Finance
    
-   [RC nº4](data/references/Resolução_Conjunta_4.md) - Resolução Conjunta nº4
