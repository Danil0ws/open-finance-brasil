...
A **Jornada Otimizada** tem como objetivo simplificar a experiência do cliente, permitindo o compartilhamento de dados a partir da jornada de pagamentos, em um fluxo unificado e mais simples. Essa abordagem busca garantir maior nível de informação e segurança ao usuário na configuração dos pagamentos, além de reduzir a ocorrência de problemas relacionados a pagamentos sem saldo disponível.
