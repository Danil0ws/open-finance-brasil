...
\*Ao reportar o uso de um endpoint /token, o identificador único de consentimento só será reportado nos casos em que "grant\_type" é do tipo "authorization\_code" ou do tipo "refresh\_token"
...
Deve ser preenchido com o valor string TRUE caso haja pelo menos um item indicado na lista do campo ".webhook\_uris" no payload, caso contrário deverá ser preenchido com a string FALSE
