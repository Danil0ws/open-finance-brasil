...
-   **Certificações funcionais:** Devem seguir as datas de _go live_ do versionamento das APIs.
...
## **8\. Posso certificar diversos** _**authorisation servers**_ **com uma única certificação?**
...
A adição de administradores pode ser realizada por qualquer administrador atual da instituição em sandbox, seguindo o  passo a passo para cadastro , que pode ser encontrado em:  Guia de Operação do Diretório Central
...
## **20\. Será possível integrar os testes funcionais e de segurança com o** _**pipeline**_ **de DevOps das instituições?**
...
## **21\. Uma instituição pode fazer testes usando** _**endpoints**_ **públicos de outra instituição?**
...
O Guia de Conformidade está disponível em: [https://openfinancebrasil.atlassian.net/wiki/download/attachments/17378905/20220912\_OpenFinance-Guia\_Motor\_De\_Conformidade\_V7.pdf?api=v2](https://openfinancebrasil.atlassian.net/wiki/download/attachments/17378905/20220912_OpenFinance-Guia_Motor_De_Conformidade_V7.pdf?api=v2)
