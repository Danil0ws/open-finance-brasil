...
Tabela de Obrigatoriedade de additionalInfo
...
Deve ser preenchido com o valor booleano TRUE caso haja pelo menos um item indicado na lista do campo ".webhook\_uris" no payload, caso contrário deverá ser preenchido com o valor booleano FALSE
