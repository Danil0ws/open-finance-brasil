...
-   Adição: Foi adicionada informação no campo nota do slide [Detalhamento dos Tipos de Contato](data/references/guides/05.md)
    
-   Atualização: Imagens da ETAPA 1: Exibindo detalhes de uma organização
    
-   Adição: Nova funcionalidade no diretório, [TAG “Habilitação de iniciação de pagamento”](data/references/guides/1.md)
    

1.2.13

-   Adição: [ETAPA 3: Removendo um recurso de uma API](data/references/guides/10.md)
...
-   Adição: foi adicionado no rodapé do slide [Cadastramento de Conglomerado](data/references/guides/1.md) uma nota que caso a organização faça parte de um conglomerado é fundamental referenciar as organizações filhas com a organização mãe.
...
-   Alteração: campo "Description" no cadastro do Authorisation Server agora é obrigatório, para maiores detalhes  [Cadastrando um Authorisation Server](data/references/guides/09.md).
...
-   Atualização do detalhamento dos [Contatos de notificação](data/references/guides/05.md).
...
-   Atualização de orientações sobre os campos Customer Friendly Server Name e Description em [Cadastrando um Authorisation Server](data/references/guides/09.md).
...
-   Adição dos detalhes sobre o cadastramento de recursos com certificação automática [Cadastramento de Recursos Fase 4A](data/references/guides/10.md).
    

1.2.5

-   Adição da definição dos tipos de contatos no diretório em [Detalhamento dos tipos de contato](data/references/guides/05.md).
...
-   Mudança na descrição do campo Client URI e retirada dos campos (mode e environment) [Criando um Software Statements](data/references/guides/12.md).
    
-   Ponto de atenção sobre usuários de plataformas em [Cadastrando reivindicações de autoridade](data/references/guides/03.md).
...
-   Alteração: Adicionado um ponto de atenção em [Criando certificados de transporte e assinatura em Sandbox](data/references/guides/07.md).
...
-   Alteração: foi alterado o detalhamento do campo “Descrição” do [Authorisation Server](data/references/guides/12.md).
    
-   Adição: foi adicionado uma descrição do [logotipo](data/references/guides/09.md).
