...
![image-20250218-170853.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531717/download)
...
-   Caso a mesma marca pertença a mais de uma organização, esta deverá ser cadastra como um único Authorisation Server em apenas uma das organizações. É vedado a duplicação de marcas, ou seja, marcas que possuem o mesmo _Customer Friendly Server Name_;
...
![image-20230405-195035.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att133759029/download)

1.  **API Participants**: Prefira por consumir dados da [**API Participants**](https://data.directory.openbankingbrasil.org.br/participants). Ela permite que o conteúdo seja fornecido ao usuário através de um servidor mais próximo, acelerando, assim, a distribuição e melhorando a experiência de consumo.
...
![image-20250217-164448.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531737/download)
...
![image-20250218-120855.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531743/download)
...
![image-20250217-165606.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531749/download)

O relacionamento entre as “organizações filhas” com a “organização mãe” é realizado via PARENT ORGANISATION REFERENCE ID, preenchendo o Parent das “organizações filhas” com o CNPJ da “organização mãe”. Quando uma “organização mãe” tem uma ou mais de uma “organização filha”, temos um conglomerado
...
![image-20250217-165651.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531755/download)
...
![image-20250217-165725.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531761/download)
...
![image-20250217-165836.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133758989/child/attachment/att869531767/download)
