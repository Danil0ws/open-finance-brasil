# Tipos de Versionamento (Segurança)

O controle de versão dos documentos de Segurança do Open Finance Brasil é composto pelos tipos de versionamento _major_, _minor_ e _patch_. Os nomes e o formato de numeração utilizados pelos tipos de versionamento são idênticos aos utilizados no _semantic versioning_, no entanto, a definição utilizada diverge.
