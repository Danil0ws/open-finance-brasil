# Disponibilização do código-fonte para auxiliar na construção de ferramentas de Dados abertos
...
Link para acessar o projeto no Github: [https://github.com/OpenBanking-Brasil/fin\_search](https://github.com/OpenBanking-Brasil/fin_search)
