...
**4.** Na janela `New Certificate`, na caixa de seleção `Select Certificate Type` selecione a opção `BRCAC_2022` e clique no botão `Continue`_._
...
![image-20230822-182005.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676207/download)![image-20230822-182027.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676213/download)
...
![image-20230822-182113.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676219/download)![image-20230822-182156.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676225/download)![image-20230822-182225.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676231/download)![image-20230822-182247.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676237/download)
...
**2.** Na janela `New Certificate`_,_ na caixa de seleção `Select Certificate Type` selecione a opção `BRSEAL` e clique no botão `Continue`_._
...
**4.** Na janela `Generate certificate - BRSEAL`, edite as informações de forma que elas sejam idênticas as informações contidas no Diretório na página de detalhes da organização, conforme especificado no Padrão de Certificados e clique no botão `Next`.

**5.** Clique no botão `Download` para baixar o arquivo brseal.cnf com as informações do certificado

![image-20230822-184137.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676243/download)![image-20230822-184158.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676249/download)
...
![image-20230822-184421.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676255/download)

![image-20230822-184437.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676261/download)![image-20230822-184453.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676267/download)![image-20230822-184514.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/133792152/child/attachment/att163676273/download)
