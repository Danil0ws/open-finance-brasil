...
Os **participantes do Open Finance Brasil** podem ser consultados a partir do arquivo localizado no _link_ [https://data.directory.openbankingbrasil.org.br/participants](https://data.directory.openbankingbrasil.org.br/participants).

A lista é composta por todos os participantes cadastrados no Diretório do Open Finance.

Os campos que contêm informações relevantes para descoberta dos _endpoints_ para a Fase 1 são:
