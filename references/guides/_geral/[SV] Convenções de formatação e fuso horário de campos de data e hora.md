...
_Existem algumas diferenças nos formatos de alguns campos nas especificações das APIs de Serviços, porém, ao implementar, leve em consideração as informações aqui registradas. Divergências serão corrigidas em momento oportuno._
