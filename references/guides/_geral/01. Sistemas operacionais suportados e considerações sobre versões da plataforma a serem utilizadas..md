...
No que se refere a versões da plataforma MISP, recomenda-se a utilização de até 5 versões (considerando o _revision_ da versão) anteriores a versão atual disponibilizada no repositório oficial da ferramenta.
