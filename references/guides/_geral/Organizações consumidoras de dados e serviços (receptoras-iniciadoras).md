...
A entrada em produção de instituições consumidora de dados e serviços só deverá ocorrer após a obtenção de certificação de segurança RP e a realização das devidas integrações com ferramentas do perímetro central. Instituições que atuarem na modalidade de iniciadoras de pagamento deverão realizar o processo de _onboarding_ de ITPs.

[Clique para conferir o passo a passo para criar uma declaração de software](data/references/guides/12.md)

[Clique para conferir o passo a passo para vinculação do papel regulatório na declaração de software](data/references/guides/13.md)

[Clique para conferir o passo a passo para registro de certificado de transporte    da declaração de software](data/references/guides/08.md)

[Clique para conferir o passo a passo para obter o](data/references/guides/14.md) _software statement assertition_ (SSA)
