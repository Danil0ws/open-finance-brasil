...
Caso não existam parcelas, para padronizar os retornos entre as instituições transmissoras, informar PARCELA\_UNICA
...
Alteração obrigatória do status AWAITING\_AUTHORISATION para REVOKED após 60 minutos

Alteração obrigatória do status AWAITING\_AUTHORISATION para REJECTED após 60 minutos
...
status\_RESOURCE\_TEMPORARILY\_UNAVAILABLE 
...
A opção SEM\_TIPO\_GARANTIA foi removida do ENUM definido para o campo WarrantyType, que continua como obrigatório. Alguns tipos de operações de crédito não possuem garantia e precisariam de tal opção
...
Considerar como opção válida o ENUM SEM\_TIPO\_GARANTIA
...
A restrição está orientando o preenchimento obrigatório quando o person type for PESSOA\_JURIDICA

O correto deveria ser PESSOA\_NATURAL
...
-   Deve ser seguida a orientação do item 6.2.1.11 do FAPI Profile 1.0 – Baseline: [https://openid.net/specs/openid-financial-api-part-1-1\_0.html](https://openid.net/specs/openid-financial-api-part-1-1_0.html)
