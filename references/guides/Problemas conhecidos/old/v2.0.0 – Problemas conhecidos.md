...
Foi identificado um erro de digitação nas especificações da v2.0.0 da API de Iniciação de Pagamentos, no qual a orientação é utilizar o ENUM DETALHE\_PGTO\_INVALIDO, quando deveriamos ter a palavra PAGAMENTO por extenso (DETALHE\_PAGAMENTO\_INVALIDO)

Deveria ser utilizado DETALHE\_PAGAMENTO\_INVALIDO ao invés de DETALHE\_PGTO\_INVALIDO no ENUM da resposta do 422

Utilizar o ENUM DETALHE\_PAGAMENTO\_INVALIDO
...
erro 400: A requisição foi malformada, omitindo atributos obrigatórios, seja no _payload_ ou através de atributos na URL
...
Seguir o conteúdo do _header_ da API
...
code: PAGAMENTO\_NAO\_PERMITE\_CANCELAMENTO
