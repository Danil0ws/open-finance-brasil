...
-   1 [Atualização do Perfil de Segurança](data/references/guides/Vis.md)
    
-   2 [Visão Geral Ecossistema](data/references/guides/Vis.md)
    
    -   2.1 [Participantes de um Ecossistema de Compartilhamento de Dados](data/references/guides/Vis.md)
        
    -   2.2 [Princípios de Especificação e Requisitos de Alto Nível](data/references/guides/Vis.md)
        
-   3 [Principais Padrões de Segurança](data/references/guides/Vis.md)
    
    -   3.1 [Estrutura de Autorização OAuth 2.0](data/references/guides/Vis.md)
        
    -   3.2 [OpenID Connect - A Camada de Identidade para a Internet](data/references/guides/Vis.md)
        
    -   3.3 [OpenID Financial Grade 1.0: Baseline](data/references/guides/Vis.md)
        
    -   3.4 [OpenID Financial Grade 1.0: Avançado](data/references/guides/Vis.md)
        
-   4 [Perfil de Segurança do Open Finance Brasil](data/references/guides/Vis.md)
    
-   5 [Camadas de Segurança Básicas](data/references/guides/Vis.md)
...
![att\_1\_for\_157351965.png](images/att_1_for_157351965.png)
