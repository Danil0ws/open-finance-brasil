...
## **Lista de contas** : (_GET_ /accounts/v1/accounts)
...
## **Identificação da conta** : (_GET_ /accounts/v1/accounts/{accountId})
...
## **Transações da conta** : (_GET_ /accounts/v1/accounts/{accountId}/transactions)
