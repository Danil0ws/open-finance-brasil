# Cenário 8: payroll-credit-portability_api_user-accepted-counteroffer_test-module_v1 - CF
...
Status 200 - Validação de resposta de acordo com a especificação e data.status igual "REJECTED" e data.rejection.rejectedBy como "CREDORA" e statusReason.reasonType como "RETENCAO\_DO\_CLIENTE"
