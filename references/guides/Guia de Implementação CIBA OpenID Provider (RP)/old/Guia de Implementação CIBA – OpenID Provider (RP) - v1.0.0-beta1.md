# Guia de Implementação CIBA – OpenID Provider (RP) - v1.0.0-beta1
...
-   não deve ser enviado no CIBA-BR;
    
-   se enviado, o OP irá ignorar e aplicar as políticas vigentes para o tempo de aprovação do consentimento;
    
-   o RP deve sempre usar o `expires_in` retornado pelo OP como referência efetiva de validade do `auth_req_id`.
