...
![invoice (1).png](images/invoice%20-1-.png)

## **Dicionário de dados**

[Fazer download do dicionário de dados pessoa natural](data/references/openapi/dictionary-getPersonalInvoiceFinancings_v1.md)

[Fazer download do dicionário de dados pessoa jurídica](data/references/openapi/dictionary-getBusinessInvoiceFinancings_v1.md)
