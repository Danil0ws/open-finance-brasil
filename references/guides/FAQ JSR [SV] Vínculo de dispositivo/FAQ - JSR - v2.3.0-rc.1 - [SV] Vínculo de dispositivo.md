# FAQ - JSR - v2.3.0-rc.1 - [SV] Vínculo de dispositivo
...
-   Para o endpoint /consents/{consentId}/authorise, deve rejeitar a solicitação com o código de erro ORIGEM\_FIDO\_INVALIDA.
    
-   Para o endpoint /recurring-consents/{recurringConsentId}/authorise, deve rejeitar a solicitação com o código de erro ORIGEM\_FIDO\_INVALIDA.
