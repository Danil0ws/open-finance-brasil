...
Qual código de erro devo utilizar quando a titularidade do usuário logado na instituição detentora for diferente do informado na criação do _enrollment_?

-   Utilizar código REJEITADO\_OUTRO
