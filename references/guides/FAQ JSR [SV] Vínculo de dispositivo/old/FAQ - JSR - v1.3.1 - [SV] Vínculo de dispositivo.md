# FAQ - JSR - v1.3.1 - [SV] Vínculo de dispositivo
...
A múltipla alçada se aplica ao pagamento em si e não ao processo de vínculo de dispositivo realizado pelo operador da conta. Por conta disto, não há status PARTIALLY\_ACCEPTED no objeto Enrollment da API.
