# Informações Gerais - [DC] Financiamento - v2.2.0

-   [Financiamentos: (GET /financings/v2/contracts)](data/references/guides/Informa.md))
    
-   [Financiamentos - Contrato: (GET /financings/v2/contracts/{contractId})](data/references/guides/Informa.md))
    
-   [Financiamentos - Garantias do Contrato: (GET /financings/v2/contracts/{contractId}/warranties)](data/references/guides/Informa.md))
    
-   [Financiamentos - Pagamentos do Contrato: (GET /financings/v2/contracts/{contractId}/payments)](data/references/guides/Informa.md))
    
-   [Financiamentos - Parcelas do Contrato: (GET /financings/v2/contracts/{contractId}/scheduled-instalments)](data/references/guides/Informa.md))
