# Cenário 11: payroll-credit-portability_api_creditor-rejected-payment-nofound_test-module_v1 - CF
...
Serão feitas a chamadas de endpoint GET /portabilities/{portabilityId} a cada 10 minutos enquanto status estiver em "RECEIVED" ou "PENDING" ou “ACCEPTED\_SETTLEMENT\_IN\_PROGRESS”
...
Status 200 - Validação de resposta de acordo com a especificação e data.status igual "REJECTED" e statusReason.reasonType como "DECURSO\_DO\_PRAZO\_PARA\_PAGAMENTO"
