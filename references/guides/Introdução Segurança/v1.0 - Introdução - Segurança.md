# v1.0 - Introdução - Segurança

Esta seção tem como finalidade auxiliar na auto avaliação aos cumprimentos dos requisitos de segurança da informação relacionados a autorização e autenticação de APIs e End-Users, emissão de certificados digitais e requisitos para o _onboarding_ no Diretório de participantes para as Instituições participantes do Open Finance Brasil.
...
[Resolução Conjunta CMN/BCB nº 1, de 2020](data/references/Resolução_Conjunta_1.md)

[Resolução CMN nº 4.658, de 2021](data/references/Resolução_CMN_4893.md)
...
[Resolução BCB nº 37, de 4 de Novembro de 2020](data/references/Instrução_Normativa_BCB_37.md)

[Resolução BCB n° 32 de 29/10/2020](data/references/Resolução_BCB_32.md)
