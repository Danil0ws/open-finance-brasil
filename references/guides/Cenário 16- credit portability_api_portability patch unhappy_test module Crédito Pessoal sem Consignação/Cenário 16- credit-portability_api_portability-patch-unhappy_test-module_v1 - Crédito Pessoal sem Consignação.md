# Cenário 16: credit-portability_api_portability-patch-unhappy_test-module_v1 - Crédito Pessoal sem Consignação
...
Garantir que há impossibilidade de se cancelar uma solicitação de portabilidade ao chegar ao estado “Accepted\_Settlement\_Completed”

**Requisito de massa**

-   Um contrato do tipo CREDITO\_PESSOAL\_CLEAN com o campo status como 'DISPONIVEL' e o campo isEligible como 'TRUE'
    
-   This test also requires action from the tester. It will poll for 10 minutes, waiting for the portability status transition to "ACCEPTED\_SETTLEMENT\_COMPLETED".
...
Status 200 - Validação de resposta e garantia que o status seja igual "ACCEPTED\_SETTLEMENT\_IN\_PROGRESS"
...
Rotina de tempo com a chamada de endpoint GET /portabilities/{portabilityId} por 10 minutos enquanto encontrar status igual a “ACCEPTED\_SETTLEMENT\_IN\_PROGRESS”

Status 200 - Validação de resposta e garantia que o status seja igual "ACCEPTED\_SETTLEMENT\_COMPLETED"
