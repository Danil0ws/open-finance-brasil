# API Pagamentos automáticos - Webhook - v1.3.0-rc.1
...
Os **eventos** que **acionarão notificações** via Webhook na máquina de estados do **consentimento de longa duração** do pagamento serão os status **REJECTED, REVOKED** e **CONSUMED** e a alteração no valor dos campos mapeados como editáveis apenas no detentor.

![image-20231108-183025.png](images/image-20231108-183025.png)
...
![image-20231107-205942.png](images/image-20231107-205942.png)
...
![Exemplo de consulta de consentimento](images/image-20231024-210259.png)

### Consulta de Pagamento

![Exemplo de consulta de pagamento](images/image-20231108-182255.png)
...
![Exemplo de URI do consentimento de longa duração](images/image-20231108-181639.png)![Exemplo de URI do pagamento automático](images/image-20231108-181835.png)
