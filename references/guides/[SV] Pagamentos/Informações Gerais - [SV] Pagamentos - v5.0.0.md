# Informações Gerais - [SV] Pagamentos - v5.0.0
...
## **Pix - Consultar iniciação de pagamento a partir do consentimento** : (GET /payments/v5/consents/{consentId}/pix/payments)
...
## **Pix - Cancelar iniciação de pagamento** : (PATCH /payments/v5/consents/{consentId}/pix/payments)
