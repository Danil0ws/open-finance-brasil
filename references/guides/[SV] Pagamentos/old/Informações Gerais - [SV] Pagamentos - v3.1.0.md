# Informações Gerais - [SV] Pagamentos - v3.1.0
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsPostConsents_v3.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsGetConsentsConsentId_v3.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsPostPixPayments_v3.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsGetPixPaymentsPaymentId_v3.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsPatchPixPaymentsPaymentId_v3.md)
