# Informações Gerais - [SV] Pagamentos - v2.1.0
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsPostConsents_v2.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsGetConsentsConsentId_v2.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsPostPixPayments_v2.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsGetPixPaymentsPaymentId_v2.md)
...
[Fazer download do dicionário de dados](data/references/openapi/dictionary-paymentsPatchPixPaymentsPaymentId_v2.md)
