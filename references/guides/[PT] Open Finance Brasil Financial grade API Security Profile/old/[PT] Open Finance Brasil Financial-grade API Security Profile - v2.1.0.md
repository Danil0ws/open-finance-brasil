# [PT] Open Finance Brasil Financial-grade API Security Profile - v2.1.0
...
17.  o tempo mínimo de expiração do _request\_uri_ deve ser de 60 segundos;
...
9.  deve enviar o cabeçalho _x-fapi-interaction-id_ em endpoints FAPI
