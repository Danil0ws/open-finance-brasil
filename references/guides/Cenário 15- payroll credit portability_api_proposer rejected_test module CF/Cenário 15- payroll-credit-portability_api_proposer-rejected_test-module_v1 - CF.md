# Cenário 15: payroll-credit-portability_api_proposer-rejected_test-module_v1 - CF
...
Chamada de endpoint PATCH /portabilities/{portabilityId}/cancel enviando rejectedBy como "PROPONENTE" e reason.type como "SALDO\_DEVEDOR\_ATUALIZADO\_SUBSTANCIALMENTE\_DIVERGENTE"
...
Status 200 - Validação de resposta de acordo com a especificação e data.status igual “REJECTED” e data.rejection.rejectBy como "PROPONENTE" e statusReason.reasonType como "SALDO\_DEVEDOR\_ATUALIZADO\_SUBSTANCIALMENTE\_DIVERGENTE"
