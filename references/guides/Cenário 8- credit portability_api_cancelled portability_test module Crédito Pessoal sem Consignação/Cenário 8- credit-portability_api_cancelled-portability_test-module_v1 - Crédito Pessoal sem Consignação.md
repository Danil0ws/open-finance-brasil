# Cenário 8: credit-portability_api_cancelled-portability_test-module_v1 - Crédito Pessoal sem Consignação
...
Status 200 - Validação de resposta e garantia que o status seja igual "CANCELLED" e statusReason.reasonType igual a 'CANCELADO\_PELO\_CLIENTE'
