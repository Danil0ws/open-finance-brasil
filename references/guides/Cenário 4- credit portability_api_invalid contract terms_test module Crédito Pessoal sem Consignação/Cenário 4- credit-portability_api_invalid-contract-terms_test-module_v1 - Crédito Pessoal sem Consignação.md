# Cenário 4: credit-portability_api_invalid-contract-terms_test-module_v1 - Crédito Pessoal sem Consignação
...
Status 422 - Validação de resposta e código de erro esperado como 'CAMPO\_INCONSISTENTE'
...
Status 422 - Validação de resposta e código de erro esperado como 'PERIODICIDADE\_INVALIDA'
...
Status 422 - Validação de resposta e código de erro esperado como 'PRAZO\_ACIMA\_LIMITE'
...
Status 422 - Validação de resposta e código de erro esperado como 'NAO\_INFORMADO'
