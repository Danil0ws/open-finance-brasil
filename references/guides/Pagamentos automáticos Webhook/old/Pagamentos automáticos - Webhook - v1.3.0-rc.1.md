# Pagamentos automáticos - Webhook - v1.3.0-rc.1
...
![image-20231108-183025.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/1053884765/child/attachment/att1053884791/download)
...
![image-20231107-205942.png](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/1053884765/child/attachment/att1053884803/download)
...
As iniciadoras e/ou detentoras poderão criar mecanismos para tratar os cenários apresentados. Por exemplo, para o Cenário 1, a iniciadora pode optar por guardar a notificação por alguns segundos na espera da finalização do POST ou pode descartar a mensagem de imediato e utilizar o _polling_.
...
![Exemplo de consulta de consentimento](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/1053884765/child/attachment/att1053884836/download)

### Consulta de Pagamento

![Exemplo de consulta de pagamento](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/1053884765/child/attachment/att1053884797/download)

## Conteúdo do Payload/ URL

O **payload** será composto pela informação do _**timestamp**_ do momento da **alteração da situação do consentimento de longa duração ou do pagamento**;
...
![Exemplo de URI do consentimento de longa duração](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/1053884765/child/attachment/att1053884806/download)![Exemplo de URI do pagamento automático](https://openfinancebrasil.atlassian.net/wiki/rest/api/content/1053884765/child/attachment/att1053884809/download)
...
_**\*O Campo é obrigatório para a instituição que optar pela utilização da funcionalidade**_

O **Parâmetro** foi **incluso** nas **tabelas** abaixo:

-   [Cabeçalhos HTTP | Cabeçalho de requisição](data/references/guides/Cabe.md)
    
-   [Cabeçalhos HTTP | Cabeçalho de resposta](data/references/guides/Cabe.md)
...
[Códigos de Resposta HTTP | Códigos de resposta HTTP](data/references/guides/C.md)

## Segurança

Todos os **endpoints** do **Webhook** utilizam-se de **mTLS** para **autenticação**, não possuem _scopes_ e _permissions_ específicos de segurança. **Toda a segurança é feita via certificado(mTLS – ICP Brasil).**

**\*** _**Não será necessário a assinatura do webhook, pois não haverão dados sensíveis no conteúdo do payload.**_
...
A iniciadora de pagamentos, ao perceber que não está recebendo as notificações oriundas da detentora de contas, poderá utilizar os _endpoints_ de consulta para obter informações sobre o andamento de uma determinada transação do consentimento e/ou pagamento.
...
-   Foram **definidos** os seguintes **requisitos não funcionais**, que podem ser **consultados no seguinte link:** Referência
