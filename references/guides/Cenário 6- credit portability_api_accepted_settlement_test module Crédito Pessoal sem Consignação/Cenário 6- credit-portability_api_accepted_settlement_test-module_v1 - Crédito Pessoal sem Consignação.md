# Cenário 6: credit-portability_api_accepted_settlement_test-module_v1 - Crédito Pessoal sem Consignação
...
-   Deverá haver uma interação humana para que realize um pool para validar o estado 'ACCEPTED\_SETTLEMENT\_IN\_PROGRESS'
